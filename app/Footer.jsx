  ...
  return (
    <footer className="footer">
        ...
        <ul style={{listStyleType:'none', display:'flex',flexDirection:'row', gap:'10px', justifyContent:'center', alignItems:'center'}}>
          <li><a href="https://twitter.com/yourprofile"><Image src={linkedin} width={30} height={30} alt='Linked In'/>  </a></li>
          <li><a href="https://facebook.com/yourprofile"><Image src={facebook} width={30} height={30} alt='Facebook'/></a></li>
          <li><a href="https://instagram.com/yourprofile"><Image src={instagram} width={30} height={30} alt='Instagram'/></a></li>
        </ul>
